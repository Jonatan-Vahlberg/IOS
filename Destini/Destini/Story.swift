...
class Story{
    var storyDictionary = [Int:StoryObject]()
    
    init(){
        storyDictionary[1] = StoryObject(
            ...
            answ1:"I\'ll hop in. Thanks for the help!",
            answ2:"Better ask him if he\'s a murderer first.",
            answ1ID:2,
            answ2ID:3)
        
        storyDictionary[2] = StoryObject(
            ...
            answ1:"I love Elton John! Hand him the cassette tape.",
            answ2:"It\'s him or me! You take the knife and stab him.",
            answ1ID:4,
            answ2ID:5)
        
        storyDictionary[3] = StoryObject(
            story:"He nods slowly, unphased by the question.",
            answ1:"At least he\'s honest. I\'ll climb in.",
            answ2:"Wait, I know how to change a tire.",
            answ1ID:2,
            answ2ID:6)
        
        storyDictionary[4] = StoryObject(
